...
public class Servlet30Jsp22 extends AbstractConfigurationFacet implements
		LibraryConfigurator {
	...
	public boolean hasLibrary(IJavaProject project) throws CoreException {
		...
		return m.containsKey(Variable.SERVLET_API_3_0)
				&& m.containsKey(Variable.JSP_API_2_2);
	}

	public void addLibrary(IJavaProject project) throws CoreException {
		ClasspathEntryUtil.addClasspathEntry(project, JavaCore
				.newVariableEntry(Variable.SERVLET_API_3_0, null,
						new Path("./")));
		ClasspathEntryUtil.addClasspathEntry(project, JavaCore
				.newVariableEntry(Variable.JSP_API_2_2, null, new Path("./")));
	}

	public void removeLibrary(IJavaProject project) throws CoreException {
		ClasspathEntryUtil.removeClasspathEntry(project,
				Variable.SERVLET_API_3_0);
		ClasspathEntryUtil.removeClasspathEntry(project, Variable.JSP_API_2_2);
	}
